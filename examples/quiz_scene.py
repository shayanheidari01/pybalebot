...
from pybalebot import Bot, Dispatcher, F, Router, html
from pybalebot.filters import Command
from pybalebot.fsm.context import FSMContext
from pybalebot.fsm.scene import Scene, SceneRegistry, ScenesManager, on
from pybalebot.fsm.storage.memory import SimpleEventIsolation
from pybalebot.types import KeyboardButton, Message, ReplyKeyboardRemove
from pybalebot.utils.formatting import (
    Bold,
    as_key_value,
    as_list,
    as_numbered_list,
...
from pybalebot.utils.keyboard import ReplyKeyboardBuilder
...
if __name__ == "__main__":
    ...
    asyncio.run(main())
    # Alternatively, you can use pybalebot-cli:
    # `pybalebot run polling quiz_scene:create_dispatcher --log-level info --token BOT_TOKEN`
