...
from pybalebot import Bot, Dispatcher, F, html
from pybalebot.filters import Command
from pybalebot.fsm.scene import After, Scene, SceneRegistry, on
...
if __name__ == "__main__":
    ...
    # `pybalebot run polling scene_example:create_dispatcher --token BOT_TOKEN --log-level info`
